    ...
    return (
      <>
        <div className="text-center">
          ...
          <button onClick={() => navigate("/dashboard/orders")} className="bg-indigo-600 text-white py-2 px-4 rounded-md">
            Back to Orders
          </button>
        </div>
      </>
    ...
    <>
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          <button onClick={() => navigate("/dashboard/orders")} className="mr-4 text-gray-500 hover:text-gray-700">
